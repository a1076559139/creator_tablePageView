...
cc.Class({
    ...
    properties: {
        ...
        _count: 0,//一共有多少节点
        _cellCount: 0,//content下有多少节点
        _showCellCount: 0,//content一个屏幕能显示多少节点
        //GRID模式下，对cell进行分组管理
    ...
    _addMethodToScrollView: function () {
        ...
        this._scrollView.scrollToNextPage = this.scrollToNextPage.bind(this);
        this._scrollView.scrollToLastPage = this.scrollToLastPage.bind(this);
    },
    ...
    getCells: function (callback) {
        if (this._initSuccess) {
            callback(orderBy(this._scrollView.content.children, 'tag'));
        } else {
            this.scheduleOnce(function () {
                callback(orderBy(this._scrollView.content.children, 'tag'));
            })
